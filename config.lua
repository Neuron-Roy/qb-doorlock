...
Config.DoorList = {
		...
		doors = {
			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(434.74, -980.76, 30.82)
			},

			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(434.74, -983.08, 30.82)
			}
		}
	},
	{
		textCoords = vec3(457.32, -971.97, 30.71),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2.5,
		doors = {
			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(458.21, -972.25, 30.82)
			},

			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(455.89, -972.25, 30.82)
			}
		}
	},
	{
		textCoords = vec3(441.95, -998.53, 30.73),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2.5,
		doors = {
			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(443.06, -998.75, 30.82)
			},

			{
				objName = -1547307588,
				objYaw = -90.0,
				objCoords = vec3(440.74, -998.75, 30.82)
			}
		}
	},
	{
		objName = -1406685646,
		objYaw = 90.0,
		objCoords  = vec3(445.41, -984.2, 30.82),
		textCoords = vec3(445.41, -984.2, 30.82),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	-- Rooftop
	{
		objName = -692649124,
		objYaw = 90.0,
		objCoords  = vec3(464.31, -984.53, 43.77),
		textCoords = vec3(464.31, -984.53, 43.77),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	-- Hallway to inside
	{
		...
		textCoords = vec3(440.52, -986.23, 30.82),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	},
	{
		...
		textCoords = vec3(440.52, -977.6, 30.82),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	},
	--Parkings Normal Doors
	{
		objName = 1830360419,
		objYaw = 90.0,
		objCoords  = vec3(464.16, -974.67, 26.37),
		textCoords = vec3(464.16, -974.67, 26.37),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	},
	{
		...
		textCoords = vec3(464.16, -997.51, 26.37),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	--Parking Grage Doors
	{
		objName = 2130672747,
		objYaw = 90.0,
		objCoords  = vec3(452.3, -1000.77, 26.7),
		textCoords = vec3(452.3, -1000.77, 26.7),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 6,
	},
	{
		...
		textCoords = vec3(431.41, -1000.77, 26.7),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 6,
		...
		doors = {
			{
				objName = -288803980,
				objYaw = 180.0,
				objCoords = vec3(469.44, -987.44, 30.82)
			},

			{
				objName = -288803980,
				objYaw = 0.0,
				objCoords = vec3(469.44, -985.03, 30.82)
			}
		}
	},
	-- Armory-1Door
	{
		...
		textCoords = vec3(479.75, -999.63, 30.79),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	-- Armory-2Door
	{
		...
		textCoords = vec3(487.44, -1000.19, 30.79),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	-- Armory [jails]
	{
		objName = -288803980,
		objYaw = -90.0,
		objCoords  = vec3(475.95, -1006.94, 26.41),
		textCoords = vec3(475.95, -1006.94, 26.41),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.5,
	...
	-- Enter-1
	{
		objName = -53345114,
		objYaw = 0.0,
		objCoords  = vec3(476.62, -1008.88, 26.48),
		textCoords = vec3(476.62, -1008.88, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Enter-2
	{
		...
		textCoords = vec3(481.01, -1004.12, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Main Cells
	{
		...
		textCoords = vec3(484.18, -1007.73, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Cell 1
	{
		...
		textCoords = vec3(477.91, -1012.19, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Cell 2
	{
		...
		textCoords = vec3(480.91, -1012.19, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Cell 3
	{
		...
		textCoords =  vec3(483.91, -1012.19, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Cell 4
	{
		...
		textCoords =  vec3(486.91, -1012.19, 26.48),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
	...
	-- Back (double doors)
	{
		textCoords = vec3(468.59, -1014.23, 26.43),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2.5,
		doors = {
			{
				objName = -692649124,
				objYaw = 0.0,
				objCoords  = vec3(469.77, -1014.41, 26.48)
			},

			{
				objName = -692649124,
				objYaw = 0.0,
				objCoords  = vec3(467.37, -1014.41, 26.48)
			}
		}
	},
	-- main jails (double doors)
	{
		textCoords = vec3(468.59, -1014.23, 26.43),
		authorizedJobs = { 'police' },
		locked = true,
		...
		doors = {
			{
				objName = 149284793,
				objYaw = 0.0,
				objCoords  = vec3(471.38, -1010.2, 26.41)
			},

			{
				objName = 149284793,
				objYaw = 0.0,
				objCoords  = vec3(471.37, -1007.79, 26.41)
			}
		}
	},
	-- Back Gate
	{
		...
		textCoords = vec3(491.03, -1023.9, 28.13),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 7
	...
	-- To Breakrooms
	{
		objName = -1406685646,
		objYaw = 90.0,
		objCoords  = vec3(458.65, -976.89, 30.82),
		textCoords = vec3(458.65, -976.89, 30.82),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 1.0,
